          ...
          <div className={"md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded " + collapseShow }>
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              <li className="items-center">
                <Link className={ "text-xs uppercase py-3 font-bold block " + (window.location.href.indexOf("/tester/patients") !== -1 ? "text-blue-500 hover:text-blue-600" : "text-gray-800 hover:text-gray-600")} to="/tester/patients">
                  <i className={"fas fa-vials mr-2 text-sm " + (window.location.href.indexOf("/tester/patients") !== -1 ? "opacity-75" : "text-gray-400")}></i> {" "} Tests
                </Link>
              </li>
              <li className="items-center">
                <Link className={ "text-xs uppercase py-3 font-bold block text-gray-800 hover:text-gray-600" } to="#" onClick={(e) => {Logout(e)}} >
                  <i className={ "fas fa-sign-out-alt mr-2 text-sm " + (window.location.href.indexOf("/tester/patients") !== -1 ? "opacity-75" : "text-gray-400")}></i>{" "}Log Out
                </Link>
              </li>
            </ul>
          </div>
